            ...
            [...contractEvents].reverse().map((event, index) => (
              ...
              >
                ...
                >
                  ...
                  >
                    {/* @ts-expect-error: event.args.sender might be undefined */}
                  ...
                  >
                    {/* @ts-expect-error: event.args.timestamp might be undefined */}
                ...
                >
                  {/* @ts-expect-error: event.args.message might be undefined */}
                  {event.args.message}
                </p>
              </div>
            ))}
